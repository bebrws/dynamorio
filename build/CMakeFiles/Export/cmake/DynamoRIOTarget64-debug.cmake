...
set_target_properties(dynamorio PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib64/debug/libdynamorio.dylib"
  IMPORTED_SONAME_DEBUG "@rpath/libdynamorio.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS dynamorio )
list(APPEND _IMPORT_CHECK_FILES_FOR_dynamorio "${_IMPORT_PREFIX}/lib64/debug/libdynamorio.dylib" )
...
set_target_properties(drmgr PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/ext/lib64/debug/libdrmgr.dylib"
  IMPORTED_SONAME_DEBUG "@rpath/libdrmgr.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS drmgr )
list(APPEND _IMPORT_CHECK_FILES_FOR_drmgr "${_IMPORT_PREFIX}/ext/lib64/debug/libdrmgr.dylib" )
...
set_target_properties(drx PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/ext/lib64/debug/libdrx.dylib"
  IMPORTED_SONAME_DEBUG "@rpath/libdrx.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS drx )
list(APPEND _IMPORT_CHECK_FILES_FOR_drx "${_IMPORT_PREFIX}/ext/lib64/debug/libdrx.dylib" )
...
set_target_properties(drwrap PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/ext/lib64/debug/libdrwrap.dylib"
  IMPORTED_SONAME_DEBUG "@rpath/libdrwrap.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS drwrap )
list(APPEND _IMPORT_CHECK_FILES_FOR_drwrap "${_IMPORT_PREFIX}/ext/lib64/debug/libdrwrap.dylib" )
...
set_target_properties(drreg PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/ext/lib64/debug/libdrreg.dylib"
  IMPORTED_SONAME_DEBUG "@rpath/libdrreg.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS drreg )
list(APPEND _IMPORT_CHECK_FILES_FOR_drreg "${_IMPORT_PREFIX}/ext/lib64/debug/libdrreg.dylib" )
...
set_target_properties(drbbdup PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/ext/lib64/debug/libdrbbdup.dylib"
  IMPORTED_SONAME_DEBUG "@rpath/libdrbbdup.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS drbbdup )
list(APPEND _IMPORT_CHECK_FILES_FOR_drbbdup "${_IMPORT_PREFIX}/ext/lib64/debug/libdrbbdup.dylib" )
...
set_target_properties(drsyms PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/ext/lib64/debug/libdrsyms.dylib"
  IMPORTED_SONAME_DEBUG "@rpath/libdrsyms.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS drsyms )
list(APPEND _IMPORT_CHECK_FILES_FOR_drsyms "${_IMPORT_PREFIX}/ext/lib64/debug/libdrsyms.dylib" )
...
set_target_properties(drutil PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/ext/lib64/debug/libdrutil.dylib"
  IMPORTED_SONAME_DEBUG "@rpath/libdrutil.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS drutil )
list(APPEND _IMPORT_CHECK_FILES_FOR_drutil "${_IMPORT_PREFIX}/ext/lib64/debug/libdrutil.dylib" )
...
set_target_properties(drcovlib PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/ext/lib64/debug/libdrcovlib.dylib"
  IMPORTED_SONAME_DEBUG "@rpath/libdrcovlib.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS drcovlib )
list(APPEND _IMPORT_CHECK_FILES_FOR_drcovlib "${_IMPORT_PREFIX}/ext/lib64/debug/libdrcovlib.dylib" )
